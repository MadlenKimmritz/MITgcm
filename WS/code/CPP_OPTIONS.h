...
CML saved from old CPP_OPTIONS.h file:
      
c$$$C these are cpp-flags related to a more efficient adjoint:
c$$$#define DISABLE_RSTAR_CODE
c$$$C we need this: #define DISABLE_MULTIDIM_ADVECTION
c$$$#define AUTODIFF_DISABLE_LEITH
c$$$#define AUTODIFF_DISABLE_REYNOLDS_SCALE

c$$$C   AUTODIFF or EXF package.
c$$$C   Currently controled by a single header file
c$$$C   For this to work, PACKAGES_CONFIG.h needs to be included!
